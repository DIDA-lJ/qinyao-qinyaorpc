...
//    }
     ...
     * 起始时间戳
     */
    public static final long START_STAMP = DateUtil.get("2023-7-16").getTime();
    /**
     * 数据中心
     */
    ...
    public IdGenerator(long dataCenterId, long machineId) {
        ...
        if (dataCenterId > DATA_CENTER_MAX || machineId > MACHINE_MAX) {
            throw new IllegalArgumentException("Data format error: The passed data center number or machine number is not valid.");
        }
